...
This project is being developed as a practical study of analytics engineering.
It emphasizes not only writing SQL, but also understanding model grain,
cardinality, reusable transformations, data quality, documentation, and the
trade-offs behind each modeling decision.
